...
(function(){
  ...
  function fit(){
    ...
    canvas.width = p.clientWidth * ratio;
    canvas.height = 220 * ratio;
    canvas.getContext('2d').scale(ratio, ratio);
  }
  window.addEventListener('resize', fit);
  fit();
  var pad = new SignaturePad(canvas, { backgroundColor: 'rgba(255,255,255,1)' });
  document.getElementById('btnClear').addEventListener('click', function(){ pad.clear(); });
